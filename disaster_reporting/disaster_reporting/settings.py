...
SECRET_KEY = 'django-insecure-34w@_(@c!%!v!hg&+gog^x=e#142h$o$v6hzfnw&@@pu@p153t'
DEBUG = True
ALLOWED_HOSTS = []
...
SIMPLE_JWT = {
    ...
    'SIGNING_KEY': SECRET_KEY,                       # Key used for encoding tokens
    'VERIFYING_KEY': None,                           # Public key to verify tokens (if applicable)
    'AUTH_HEADER_TYPES': ('Bearer',),                # Type of authorization header
    'USER_ID_FIELD': 'id',                           # Field used for user identification
    'USER_ID_CLAIM': 'user_id',                      # Claim used for user identification
}

# CORS settings
CORS_ALLOWED_ORIGINS = [
    'http://localhost:5173',  # Replace with your frontend URL if needed
]
...
ROOT_URLCONF = 'disaster_reporting.urls'
...
WSGI_APPLICATION = 'disaster_reporting.wsgi.application'
